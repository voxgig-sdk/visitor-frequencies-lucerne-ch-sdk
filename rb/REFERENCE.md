# VisitorFrequenciesLucerneCh Ruby SDK Reference

Complete API reference for the VisitorFrequenciesLucerneCh Ruby SDK.
...
#### `VisitorFrequenciesLucerneChSDK.test(testopts = nil, sdkopts = nil)`
