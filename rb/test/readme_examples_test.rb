...
#      offline in seeded test mode (VisitorFrequenciesLucerneChSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "VisitorFrequenciesLucerneCh_sdk.rb")
  SDK_CLASS = "VisitorFrequenciesLucerneChSDK"
  ...
  SDK_BASE = "VisitorFrequenciesLucerneCh_sdk"
