...
class SearchEntityTest < Minitest::Test
  ...
  def test_stream
    ...
    base = VisitorFrequenciesLucerneChSDK.test(seed, nil)
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set VISITOR_FREQUENCIES_LUCERNE_CH_TEST_SEARCH_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def search_basic_setup(extra)
  ...
  entid_env_raw = ENV["VISITOR_FREQUENCIES_LUCERNE_CH_TEST_SEARCH_ENTID"]
