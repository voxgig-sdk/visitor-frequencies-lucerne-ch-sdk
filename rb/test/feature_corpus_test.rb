# VisitorFrequenciesLucerneCh SDK feature corpus test
#
...
class FeatureCorpusTest < Minitest::Test
  ...
  #
  # VisitorFrequenciesLucerneChSDK.new, not VisitorFrequenciesLucerneChSDK.test: the `test` feature is
  ...
  def build_client(kase)
    ...
    VisitorFrequenciesLucerneChSDK.new(opts)
  end
