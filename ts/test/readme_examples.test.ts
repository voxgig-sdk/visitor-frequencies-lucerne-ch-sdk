...
//     (\`new VisitorFrequenciesLucerneChSDK(...)\` / \`VisitorFrequenciesLucerneChSDK.test(...)\` become
//     \`VisitorFrequenciesLucerneChSDK.test({ entity: ... })\`), transpiled to JS, and run
...
const SDK_NAME = 'VisitorFrequenciesLucerneChSDK'
...
// rewrite real client construction (\`new VisitorFrequenciesLucerneChSDK(...)\` and any
// \`VisitorFrequenciesLucerneChSDK.test(...)\`) to a seeded test-mode client, and give
...
function rewriteForRun(code: string): string {
  ...
  out = out.replace(/new\s+VisitorFrequenciesLucerneChSDK\s*\([^)]*\)/g, () => SEEDED_CTOR)
  out = out.replace(/VisitorFrequenciesLucerneChSDK\.test\s*\([^)]*\)/g, () => SEEDED_CTOR)
