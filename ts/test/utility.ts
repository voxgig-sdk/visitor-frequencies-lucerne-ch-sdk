...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.VISITORFREQUENCIESLUCERNECH_TEST_LIVE ||
    'TRUE' === process.env.VISITORFREQUENCIESLUCERNECH_TEST_OVERRIDE
  ) {
  ...
  m.VISITORFREQUENCIESLUCERNECH_TEST_EXPLAIN = process.env.VISITORFREQUENCIESLUCERNECH_TEST_EXPLAIN || m.VISITORFREQUENCIESLUCERNECH_TEST_EXPLAIN
