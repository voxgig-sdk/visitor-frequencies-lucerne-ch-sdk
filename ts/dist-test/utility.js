...
function envOverride(m) {
    if ('TRUE' === process.env.VISITOR_FREQUENCIES_LUCERNE_CH_TEST_LIVE ||
        'TRUE' === process.env.VISITOR_FREQUENCIES_LUCERNE_CH_TEST_OVERRIDE) {
    ...
    m.VISITOR_FREQUENCIES_LUCERNE_CH_TEST_EXPLAIN = process.env.VISITOR_FREQUENCIES_LUCERNE_CH_TEST_EXPLAIN || m.VISITOR_FREQUENCIES_LUCERNE_CH_TEST_EXPLAIN;
    return m;
}
