...
const VisitorFrequenciesLucerneChError_1 = require("./VisitorFrequenciesLucerneChError");
...
class Context {
    ...
    error(code, msg) {
        return new VisitorFrequenciesLucerneChError_1.VisitorFrequenciesLucerneChError(code, msg, this);
    }
    toJSON() {
        return {
            id: this.id,
