# VisitorFrequenciesLucerneCh SDK — root README python-examples test.
#
...
def test_readme_python_blocks_typecheck():
    ...
    with tempfile.TemporaryDirectory() as td:
        ...
        # Resolve "from visitorfrequencieslucernech_sdk import VisitorFrequenciesLucerneChSDK" against the package root.
...
def test_readme_testmode_snippets_run():
    ...
    for i, block in enumerate(blocks):
        ...
        namespace = {"VisitorFrequenciesLucerneChSDK": VisitorFrequenciesLucerneChSDK, "os": os}
        try:
