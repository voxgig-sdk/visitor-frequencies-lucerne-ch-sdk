# VisitorFrequenciesLucerneCh SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions VisitorFrequenciesLucerneChSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both VisitorFrequenciesLucerneChSDK(...) and VisitorFrequenciesLucerneChSDK.test(...) become
#      VisitorFrequenciesLucerneChSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "visitorfrequencieslucernech_sdk"
_SDK_CLASS = "VisitorFrequenciesLucerneChSDK"
