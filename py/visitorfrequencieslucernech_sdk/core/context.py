...
from visitorfrequencieslucernech_sdk.core.helpers import get_ctx_prop, to_map
...
class VisitorFrequenciesLucerneChContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = VisitorFrequenciesLucerneChControl()
        ...
        if isinstance(sp, VisitorFrequenciesLucerneChSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, VisitorFrequenciesLucerneChResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, VisitorFrequenciesLucerneChResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return VisitorFrequenciesLucerneChOperation({})
    ...
    def make_error(self, code, msg):
        return VisitorFrequenciesLucerneChError(code, msg, self)
