...
from visitorfrequencieslucernech_sdk.utility import register

# Load features
from visitorfrequencieslucernech_sdk.feature.base_feature import VisitorFrequenciesLucerneChBaseFeature
from visitorfrequencieslucernech_sdk.features import _has_feature, _make_feature
...
class VisitorFrequenciesLucerneChSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = VisitorFrequenciesLucerneChUtility()
        self._utility = utility

        from visitorfrequencieslucernech_sdk.config import shared_config
    ...
    def get_utility(self):
        return VisitorFrequenciesLucerneChUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("VisitorFrequenciesLucerneChSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Search(self, data=None) -> "SearchEntity":
        ...
        from visitorfrequencieslucernech_sdk.entity.search_entity import SearchEntity
        return SearchEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "VisitorFrequenciesLucerneChSDK":
        if sdkopts is None:
            sdkopts = {}
