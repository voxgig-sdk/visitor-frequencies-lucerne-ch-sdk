# VisitorFrequenciesLucerneCh Python SDK Reference

Complete API reference for the VisitorFrequenciesLucerneCh Python SDK.
...
#### `VisitorFrequenciesLucerneChSDK.test(testopts=None, sdkopts=None)`
