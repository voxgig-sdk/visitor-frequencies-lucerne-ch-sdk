...
// VisitorFrequenciesLucerneCh SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (VisitorFrequenciesLucerneChSDK::test)
...
{
    private const SDK_CLASS = 'VisitorFrequenciesLucerneChSDK';
    ...
    private const SDK_BASE = 'visitorfrequencieslucernech_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../visitorfrequencieslucernech_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
