...
// VisitorFrequenciesLucerneCh SDK proxy feature
...
class VisitorFrequenciesLucerneChProxyFeature extends VisitorFrequenciesLucerneChBaseFeature
{
    ...
    public function init(VisitorFrequenciesLucerneChContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (VisitorFrequenciesLucerneChContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
