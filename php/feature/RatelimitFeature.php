...
// VisitorFrequenciesLucerneCh SDK ratelimit feature
...
class VisitorFrequenciesLucerneChRatelimitFeature extends VisitorFrequenciesLucerneChBaseFeature
{
    ...
    private function _acquire(VisitorFrequenciesLucerneChContext $ctx): void
    {
    ...
    private function _track(VisitorFrequenciesLucerneChContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
