...
// VisitorFrequenciesLucerneCh SDK utility: graphql
//
...
class VisitorFrequenciesLucerneChGraphql
{
    ...
    // equivalent.
    public static function body(VisitorFrequenciesLucerneChContext $ctx): mixed
    {
    ...
    public static function errors(VisitorFrequenciesLucerneChContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
