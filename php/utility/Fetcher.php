...
// VisitorFrequenciesLucerneCh SDK utility: fetcher

class VisitorFrequenciesLucerneChFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; VisitorFrequenciesLucerneChSDK/1.0)';
    ...
    public static function call(VisitorFrequenciesLucerneChContext $ctx, string $fullurl, array $fetchdef): array
    {
