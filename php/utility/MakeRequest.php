...
// VisitorFrequenciesLucerneCh SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class VisitorFrequenciesLucerneChMakeRequest
{
    public static function call(VisitorFrequenciesLucerneChContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new VisitorFrequenciesLucerneChResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new VisitorFrequenciesLucerneChResponse($fetched);
        } else {
