...
func registerSDKWords(r *eng.Registry, client *sdk.VisitorFrequenciesLucerneChSDK) {
...
func runOp(client *sdk.VisitorFrequenciesLucerneChSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
