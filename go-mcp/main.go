// Command VisitorFrequenciesLucerneCh-mcp is an MCP server exposing the VisitorFrequenciesLucerneCh
// SDK as MCP tools.
//
// Two tools are registered:
//
//	VisitorFrequenciesLucerneCh_list  — list records of an entity
//	VisitorFrequenciesLucerneCh_load  — load a single record of an entity
//
