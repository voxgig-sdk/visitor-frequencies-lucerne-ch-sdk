...
func registerTools(server *mcp.Server, client *sdk.VisitorFrequenciesLucerneChSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "visitor-frequencies-lucerne-ch_list",
		Description: "List records from VisitorFrequenciesLucerneCh. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "visitor-frequencies-lucerne-ch_load",
		Description: "Load a single record from VisitorFrequenciesLucerneCh. " +
...
func runOp(client *sdk.VisitorFrequenciesLucerneChSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.VisitorFrequenciesLucerneChSDK, name string) (sdk.VisitorFrequenciesLucerneChEntity, error) {
