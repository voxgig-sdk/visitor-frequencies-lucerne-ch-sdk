...
// VisitorFrequenciesLucerneCh SDK utility type

class VisitorFrequenciesLucerneChUtility
{
    ...
    public static function copy(VisitorFrequenciesLucerneChUtility $src): VisitorFrequenciesLucerneChUtility
    {
        $u = new VisitorFrequenciesLucerneChUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
