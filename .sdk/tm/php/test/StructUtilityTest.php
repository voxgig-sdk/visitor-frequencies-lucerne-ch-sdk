...
// VisitorFrequenciesLucerneCh SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = VisitorFrequenciesLucerneChOmni::makeStructRunner(
    ...
    {
        return VisitorFrequenciesLucerneChOmni::objmodel(VisitorFrequenciesLucerneChOmni::argval($val));
    }

    /** A single-case fixture value on the comparison side. */
    private static function outval($val)
    {
        return VisitorFrequenciesLucerneChOmni::unmark($val);
    }

    /** A result normalised to the comparison model. */
    private static function resval($val)
    {
        return VisitorFrequenciesLucerneChOmni::structfix($val, Struct::undef());
    }
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(VisitorFrequenciesLucerneChOmni::structfix($now, Struct::undef()))
                        !== json_encode(VisitorFrequenciesLucerneChOmni::structfix($val, Struct::undef()))) {
