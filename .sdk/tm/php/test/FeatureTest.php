...
// VisitorFrequenciesLucerneCh SDK feature test
//
...
class FtCtrl extends VisitorFrequenciesLucerneChControl
{
...
class FtClient
{
    ...
    private VisitorFrequenciesLucerneChUtility $utility;

    public function __construct(VisitorFrequenciesLucerneChUtility $utility, array $options)
    {
    ...
    public function get_utility(): VisitorFrequenciesLucerneChUtility
    {
        return $this->utility;
    }
}
...
class FtRecorder
{
    ...
    {
        return function (VisitorFrequenciesLucerneChContext $_ctx, string $url, array $fetchdef): array {
...
class FtHarness
{
    ...
    public VisitorFrequenciesLucerneChContext $rootctx;
    ...
    public function __construct(
        ...
        $utility->fetcher = $server ?? function (VisitorFrequenciesLucerneChContext $_ctx, string $_url, array $fetchdef): array {
        ...
        foreach ($features as $fspec) {
            ...
            $f = VisitorFrequenciesLucerneChConfig::make_feature($name);
    ...
    private static function buildUrl(VisitorFrequenciesLucerneChSpec $spec): string
    {
        $keys = [];
    ...
    public function op(array $o = []): array
    {
        ...
        if (($ctx->out['point'] ?? null) instanceof VisitorFrequenciesLucerneChError) {
        ...
        if (is_array($fetched)) {
            $ctx->response = new VisitorFrequenciesLucerneChResponse($fetched);
        }
    ...
    private function fail(VisitorFrequenciesLucerneChContext $ctx, mixed $err): array
    {
...
class FeatureTest extends TestCase
{
    ...
    public function test_retry_retries_a_transport_error_until_exhausted(): void
    {
        ...
        $clock = new FtClock();
        $n = 0;
        $server = function (VisitorFrequenciesLucerneChContext $ctx, string $_url, array $_fd) use (&$n): array {
            $n++;
