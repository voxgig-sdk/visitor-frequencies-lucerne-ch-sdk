...
// VisitorFrequenciesLucerneCh SDK pipeline test
//
...
{
    private static function utility(): VisitorFrequenciesLucerneChUtility
    {
        return new VisitorFrequenciesLucerneChUtility();
    }
    ...
    private static function ctx(array $over = []): VisitorFrequenciesLucerneChContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new VisitorFrequenciesLucerneChContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new VisitorFrequenciesLucerneChOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof VisitorFrequenciesLucerneChError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new VisitorFrequenciesLucerneChOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = VisitorFrequenciesLucerneChMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new VisitorFrequenciesLucerneChOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = VisitorFrequenciesLucerneChMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new VisitorFrequenciesLucerneChOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = VisitorFrequenciesLucerneChMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new VisitorFrequenciesLucerneChSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = VisitorFrequenciesLucerneChMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new VisitorFrequenciesLucerneChResponse([]),
            'result' => new VisitorFrequenciesLucerneChResult([]),
        ]);
        [, $err] = VisitorFrequenciesLucerneChMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new VisitorFrequenciesLucerneChSpec([]),
            'response' => null,
            'result' => new VisitorFrequenciesLucerneChResult([]),
        ]);
        [, $err] = VisitorFrequenciesLucerneChMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new VisitorFrequenciesLucerneChSpec(['step' => 's']),
            'response' => new VisitorFrequenciesLucerneChResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new VisitorFrequenciesLucerneChResult([]),
        ]);
        [, $err] = VisitorFrequenciesLucerneChMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new VisitorFrequenciesLucerneChSpec(['step' => 's']),
            'response' => new VisitorFrequenciesLucerneChResponse(self::resp(200, ['v' => 1])),
            'result' => new VisitorFrequenciesLucerneChResult([]),
        ]);
        [, $err] = VisitorFrequenciesLucerneChMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new VisitorFrequenciesLucerneChSpec(['step' => 's']),
            'response' => new VisitorFrequenciesLucerneChResponse(self::resp(200, ['v' => 2])),
            'result' => new VisitorFrequenciesLucerneChResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        VisitorFrequenciesLucerneChMakeResponse::call($ctx);
    ...
    {
        $preset = new VisitorFrequenciesLucerneChResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new VisitorFrequenciesLucerneChSpec([]),
            'response' => new VisitorFrequenciesLucerneChResponse([]),
            'result' => new VisitorFrequenciesLucerneChResult([]),
        ...
        [$got, $err] = VisitorFrequenciesLucerneChMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new VisitorFrequenciesLucerneChResult([])]);
        [, $err] = VisitorFrequenciesLucerneChMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new VisitorFrequenciesLucerneChSpec([]), 'result' => null]);
        [, $err] = VisitorFrequenciesLucerneChMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new VisitorFrequenciesLucerneChSpec(['step' => 's']),
            'result' => new VisitorFrequenciesLucerneChResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new VisitorFrequenciesLucerneChOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = VisitorFrequenciesLucerneChMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new VisitorFrequenciesLucerneChSpec(['step' => 's']),
            'result' => new VisitorFrequenciesLucerneChResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new VisitorFrequenciesLucerneChOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = VisitorFrequenciesLucerneChMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new VisitorFrequenciesLucerneChResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new VisitorFrequenciesLucerneChSpec([]),
            'result' => new VisitorFrequenciesLucerneChResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = VisitorFrequenciesLucerneChMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = VisitorFrequenciesLucerneChMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new VisitorFrequenciesLucerneChError('boom', 'boom');
        $utility->fetcher = function (VisitorFrequenciesLucerneChContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new VisitorFrequenciesLucerneChSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = VisitorFrequenciesLucerneChMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (VisitorFrequenciesLucerneChContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = VisitorFrequenciesLucerneChMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(VisitorFrequenciesLucerneChResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        VisitorFrequenciesLucerneChMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (VisitorFrequenciesLucerneChContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new VisitorFrequenciesLucerneChSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = VisitorFrequenciesLucerneChMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new VisitorFrequenciesLucerneChResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new VisitorFrequenciesLucerneChSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = VisitorFrequenciesLucerneChMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = VisitorFrequenciesLucerneChMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = VisitorFrequenciesLucerneChMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new VisitorFrequenciesLucerneChResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, VisitorFrequenciesLucerneChDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new VisitorFrequenciesLucerneChResult(['ok' => false])]);
        $this->expectException(VisitorFrequenciesLucerneChError::class);
        VisitorFrequenciesLucerneChDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new VisitorFrequenciesLucerneChResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', VisitorFrequenciesLucerneChMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        VisitorFrequenciesLucerneChMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new VisitorFrequenciesLucerneChBaseFeature();
        $b = new VisitorFrequenciesLucerneChBaseFeature();
        VisitorFrequenciesLucerneChFeatureAdd::call($ctx, $a);
        VisitorFrequenciesLucerneChFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): VisitorFrequenciesLucerneChBaseFeature
    {
        $f = new VisitorFrequenciesLucerneChBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        VisitorFrequenciesLucerneChFeatureAdd::call($ctx, self::named_feature('a'));
        VisitorFrequenciesLucerneChFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        VisitorFrequenciesLucerneChFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        VisitorFrequenciesLucerneChFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        VisitorFrequenciesLucerneChFeatureAdd::call($ctx, $replace);
        ...
        VisitorFrequenciesLucerneChFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): VisitorFrequenciesLucerneChContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new VisitorFrequenciesLucerneChSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = VisitorFrequenciesLucerneChPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        VisitorFrequenciesLucerneChPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new VisitorFrequenciesLucerneChResponse(['headers' => null]),
            'result' => new VisitorFrequenciesLucerneChResult([]),
        ]);
        VisitorFrequenciesLucerneChResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        VisitorFrequenciesLucerneChResultBody::call($ctx);
