...
// VisitorFrequenciesLucerneCh SDK utility: make_spec

require_once __DIR__ . '/Graphql.php';

require_once __DIR__ . '/../core/Spec.php';

class VisitorFrequenciesLucerneChMakeSpec
{
    public static function call(VisitorFrequenciesLucerneChContext $ctx): array
    {
        ...
        if ('graphql' === \Voxgig\Struct\Struct::getprop($point, 'kind')) {
            ...
            $ctx->spec->query = [];
            $ctx->spec->headers['content-type'] = VisitorFrequenciesLucerneChGraphql::CONTENT_TYPE;
        } else {
