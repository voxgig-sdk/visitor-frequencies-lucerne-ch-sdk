...
// VisitorFrequenciesLucerneCh SDK timeout feature
...
class VisitorFrequenciesLucerneChTimeoutFeature extends VisitorFrequenciesLucerneChBaseFeature
{
    ...
    private function _with_timeout(VisitorFrequenciesLucerneChContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(VisitorFrequenciesLucerneChContext $_ctx, float $ms): void
    {
        $client = $this->client;
