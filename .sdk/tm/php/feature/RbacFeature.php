...
// VisitorFrequenciesLucerneCh SDK rbac feature
...
class VisitorFrequenciesLucerneChRbacFeature extends VisitorFrequenciesLucerneChBaseFeature
{
    ...
    private function _required(VisitorFrequenciesLucerneChContext $ctx): ?string
    {
    ...
    private function _reject(VisitorFrequenciesLucerneChContext $ctx, string $required): void
    {
    ...
    private function _track(VisitorFrequenciesLucerneChContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
