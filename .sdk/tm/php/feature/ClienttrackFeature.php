...
// VisitorFrequenciesLucerneCh SDK clienttrack feature
...
class VisitorFrequenciesLucerneChClienttrackFeature extends VisitorFrequenciesLucerneChBaseFeature
{
    ...
    public function PostConstruct(VisitorFrequenciesLucerneChContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'VisitorFrequenciesLucerneCh-SDK';
