...
// VisitorFrequenciesLucerneCh SDK cache feature
...
class VisitorFrequenciesLucerneChCacheFeature extends VisitorFrequenciesLucerneChBaseFeature
{
    ...
    private function _through(VisitorFrequenciesLucerneChContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
