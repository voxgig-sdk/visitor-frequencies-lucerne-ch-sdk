...
// VisitorFrequenciesLucerneCh SDK netsim feature
...
class VisitorFrequenciesLucerneChNetsimFeature extends VisitorFrequenciesLucerneChBaseFeature
{
    ...
    private function _simulate(VisitorFrequenciesLucerneChContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(VisitorFrequenciesLucerneChContext $ctx, array $applied): void
    {
        $client = $this->client;
