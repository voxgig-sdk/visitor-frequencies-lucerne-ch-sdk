...
// VisitorFrequenciesLucerneCh SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class VisitorFrequenciesLucerneChTestFeature extends VisitorFrequenciesLucerneChBaseFeature
{
    ...
    public function init(VisitorFrequenciesLucerneChContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (VisitorFrequenciesLucerneChContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = VisitorFrequenciesLucerneChParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (VisitorFrequenciesLucerneChContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(VisitorFrequenciesLucerneChContext $ctx, $op, $args): array
    {
        ...
        foreach ($keys as $k) {
            ...
            if ($is_id || $in_reqd) {
                $v = VisitorFrequenciesLucerneChParam::call($ctx, $k);
