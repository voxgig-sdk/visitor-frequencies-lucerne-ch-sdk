...
|---|---|---|
| `ts/` | @voxgig-sdk/visitor-frequencies-lucerne-ch-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/visitor-frequencies-lucerne-ch-sdk \
      --repository voxgig-sdk/visitor-frequencies-lucerne-ch-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/visitor-frequencies-lucerne-ch-sdk` shows it, and
`npm trust revoke @voxgig-sdk/visitor-frequencies-lucerne-ch-sdk --id=<id>` removes it.
