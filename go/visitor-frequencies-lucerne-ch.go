...
import (
	...
	"github.com/voxgig-sdk/visitor-frequencies-lucerne-ch-sdk/go/entity"
	"github.com/voxgig-sdk/visitor-frequencies-lucerne-ch-sdk/go/feature"
	_ "github.com/voxgig-sdk/visitor-frequencies-lucerne-ch-sdk/go/utility"
)
...
// instead of `sdk.NewVisitorFrequenciesLucerneChSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *VisitorFrequenciesLucerneChSDK  { return NewVisitorFrequenciesLucerneChSDK(nil) }
func Test() *VisitorFrequenciesLucerneChSDK { return TestSDK(nil, nil) }
