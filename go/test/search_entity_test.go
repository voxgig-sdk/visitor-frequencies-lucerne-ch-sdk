...
func searchBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("VISITOR_FREQUENCIES_LUCERNE_CH_TEST_SEARCH_ENTID")
	...
	idmapResolved := core.ToMapAny(env["VISITOR_FREQUENCIES_LUCERNE_CH_TEST_SEARCH_ENTID"])
